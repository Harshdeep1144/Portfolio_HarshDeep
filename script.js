var animator = (() => {
    ...
    function oe(e, t, r, o, s) {
        ...
        E.set(n, !1), C.ready ? C.ready.then(f).catch(j) : f()
    }
...
// Data from the script tags
const framerAnimationsContent = {
    "honat9": {
        "default": {
            "initial": {
                "opacity": 1,
...
// IIFE to run the animation logic
(() => {
    function c(i, o, m) {
        if (window.__framer_disable_appear_effects_optimization__ || typeof animator === "undefined") return;
        let e = {
            detail: {
                bg: document.hidden
            }
        ...
        requestAnimationFrame(() => {
            ...
            animator.animateAppearEffects(
                ...
                i,
                o,
                m && window.matchMedia("(prefers-reduced-motion:reduce)").matches === true,
                animator.getActiveVariantHash(framerBreakpoints)
            );
    ...
    document.addEventListener("DOMContentLoaded", () => {
         c("data-framer-appear-id", "__Appear_Animation_Transform__", false);
    });
})();

// --- Appended Scripts ---

// Nested link handling
(() => {
    function u() {
        function n(t, e, i) {
        ...
        function a(t) {
            if (this.dataset.hydrated) {
                this.removeEventListener("auxclick", a);
                return
            }
            t.preventDefault(), t.stopPropagation();
            let e = this.getAttribute("href");
...
// Responsive image sizes handling
(() => {
    function i() {
...
! function() {
    ...
    var l = 'div#main a[href^="#"],div#main a[href^="/"],div#main a[href^="."]',
        ...
        g = true; // Hardcoded to true as document.currentScript is not available in external files
